...
V_77 = Vertex(name = 'V_77',
              particles = [ P.t__tilde__, P.tp, P.a ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV3 ],
...
V_79 = Vertex(name = 'V_79',
              particles = [ P.t__tilde__, P.tp, P.g ],
              color = [ 'T(3,2,1)' ],
              lorentz = [ L.FFV3 ],
              couplings = {(0,0):C.GC_11})

V_80 = Vertex(name = 'V_80',
              particles = [ P.t__tilde__, P.tp, P.g, P.g ],
              color = [ 'f(-1,3,4)*T(-1,2,1)' ],
              lorentz = [ L.FFVV1 ],
              couplings = {(0,0):C.GC_13})

V_81 = Vertex(name = 'V_81',
              particles = [ P.tp__tilde__, P.t, P.a ],
              color = [ 'Identity(1,2)' ],
              lorentz = [ L.FFV7 ],
              couplings = {(0,0):C.GC_10})
...
V_83 = Vertex(name = 'V_83',
              particles = [ P.tp__tilde__, P.t, P.g ],
              color = [ 'T(3,2,1)' ],
              lorentz = [ L.FFV7 ],
              couplings = {(0,0):C.GC_11})

V_84 = Vertex(name = 'V_84',
              particles = [ P.tp__tilde__, P.t, P.g, P.g ],
              color = [ 'f(-1,3,4)*T(-1,2,1)' ],
              lorentz = [ L.FFVV2 ],
              couplings = {(0,0):C.GC_13})
